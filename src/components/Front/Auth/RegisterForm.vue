...
<template>
  <TransitionRoot as="template" :show="registerFormStatus">
    <Dialog as="div" class="fixed z-10 inset-0 overflow-y-auto" @close="registerFormStatus = false">
