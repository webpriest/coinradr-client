          ...
          <div class="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
            ...
            <form @submit.prevent="login" @keydown="form.onKeydown($event)">
              <div>
                ...
                <div class="isolate -space-y-px rounded-md shadow-sm mt-4">
                  <div class="relative border border-red-300 rounded-md rounded-b-none px-3 py-2 focus-within:z-10 focus-within:ring-1 focus-within:ring-red-600 focus-within:border-red-600">
                    ...
                    <input type="email" id="email" class="block w-full border-0 focus:outline-none border-gray-100 p-0 text-gray-900 placeholder-gray-500 focus:ring-0 sm:text-sm" placeholder="jane.doe@yourdomain.com" autocomplete="off" v-model="forms.email"  />
                  ...
                  <div class="relative border border-red-300 rounded-md rounded-t-none px-3 py-2 focus-within:z-10 focus-within:ring-1 focus-within:ring-red-600 focus-within:border-red-600">
                    ...
                    <input type="password" id="password" class="block w-full border-0 focus:outline-none p-0 text-gray-900 placeholder-gray-500 focus:ring-0 sm:text-sm" placeholder="*********" v-model="forms.password"  />
              ...
              <div class="mt-5 sm:mt-6">
                <button :form="form" class="color-button inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:text-sm">
...
import { LockClosedIcon, LockOpenIcon, LoginIcon } from '@heroicons/vue/outline'
